...
namespace Microsoft.Msagl.Core.Geometry
{
	...
	public struct Rectangle
	{
		...
		/// <summary>
		/// Borrows logic from System.Drawing.RectangleF with the caveat of converting between Flaod anf Double
		/// </summary>
		/// <param name="r1"></param>
		/// <param name="r2"></param>
		/// <returns></returns>
		...
		{
			// Why the fuck is the whole Graph coordinate system is not matching System.Drawing ????? Top <=> Bottom !
			System.Drawing.RectangleF rf1 = new System.Drawing.RectangleF((float)r1.Left, (float)r1.Bottom, (float)r1.Width, (float)r1.Height);
			System.Drawing.RectangleF rf2 = new System.Drawing.RectangleF((float)r2.Left, (float)r2.Bottom, (float)r2.Width, (float)r2.Height);
			System.Drawing.RectangleF urf = System.Drawing.RectangleF.Union(rf1, rf2);
			var r = new Rectangle(urf.X, urf.Y + urf.Height, urf.X + urf.Width, urf.Y);
			return r;
		}
	}
}