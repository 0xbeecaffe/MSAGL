...
namespace Microsoft.Msagl.WpfGraphControl
{
	internal class VLabel : IViewerObject, IInvalidatable
	{
		...
		DateTime markedForDraggintTimestamp;
		...
		public bool MarkedForDragging
		{
			...
			set
			{
				...
				if (value)
				{
					this.markedForDraggintTimestamp = DateTime.Now;
		...
		public DateTime MarkedForDraggingTimeStamp { get { return this.markedForDraggintTimestamp; } }
